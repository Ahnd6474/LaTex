...
highly optimized prefilter and as a standalone alternative to BLAST in large-scale
sequence search~\cite{Steinegger2017MMseqs2,Steinegger2018Linclust}. MMseqs2 employs a cascade of $k$-mer based filters and ungapped
...
enforces an explicit, user-controllable candidate budget (via $N_{\max}$ and Top-$K$)
